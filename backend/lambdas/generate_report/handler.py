...
def generate_report_pdf(report: dict, ngo_name: str, period: str, beneficiaries: int, funds: int) -> bytes:
    ...
    try:
        ...
        # Fallback: return formatted text as bytes
    ...
    pdf.multi_cell(0,10,period,align="C")
    pdf.set_font("Helvetica","",12); pdf.set_text_color(80,80,80)
    pdf.multi_cell(0,8,f"Organization: {ngo_name}",align="C")
    ...
    if highlights:
        ...
        for h in highlights:
            ...
            pdf.multi_cell(0,6,f"  * {h}"); pdf.ln(1)
        pdf.ln(3)

    # Declaration
    pdf.section("8. Declaration")
    pdf.body(f"This report has been prepared by {ngo_name} using the NidhiAI platform. "
             f"All data presented reflects actual program activities during {period}. "
